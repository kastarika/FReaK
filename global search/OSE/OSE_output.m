function traj_list = OSE_output(max_time, time_step, simu_name, c, ro, lb, ub, omega, CR, max_iter, select_dims, input_dims)
    ...
    for iter = 1:max_iter
        ...
        % lower_limit = [61.2 900];
        % upper_limit = [81.2 1100];
